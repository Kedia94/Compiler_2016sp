...
begin
	...
	i := -(-(2147483647)) * 2147483647;           // pass
	i := -(-(-2147483647)) / (-(-2147483647));    // pass
	i := -(-(2147483647 * (-2147483647)) + 2147483647) * (2147483647 - (-2147483647) * (-2147483647)); // pass
	i := -j + (-i * 2147483647);                  // pass
	i := (-i * (-(-j)) / 2147483647) - (-j + 2147483647 * (-2147483647)); // pass
	i := -(-(2147483647 * (-(-j)) / (-i) + 2147483647 - (-2147483647)) * (-i + j)) * (-(-2147483647 * (-i + j * (-j)))); // pass
	i := -(-(2147483647 * (-(-((j)))) / (-(i)) + ((-(-2147483647)))) * (-i / (i) + j)) / ((-2147483647 *(-j * ((-i + 2147383647) * (-2147483647)) + (-j)))); // pass
	i := +i + j;                                  // pass
	i := +(+i) * (-j + i);                        // pass
	i := +i + (+j * ((+i / (-((-(j + (+(-(+(((+i - ((+(-((((+(((+(j)))))))))))))))))))))))); // pass
