...
l_test02_4_while_cond:
    movl    i, %eax                 #  34:     if     i < 10 goto 5_while_body
    movl    $10, %ebx              
    cmpl    %ebx, %eax             
    jl      l_test02_5_while_body  
...
l_test02_11_while_cond:
    movl    i, %eax                 #  52:     if     i < 10 goto 12_while_body
    movl    $10, %ebx              
    cmpl    %ebx, %eax             
    jl      l_test02_12_while_body 
